    ...
    <div className="footer-bg">
      <div className="">
        <div className="row px-4 py-3">
          <div className="col-md-6 d-flex">
            <div style={{marginLeft:"25%"}} data-aos="fade-up">
              <p className="text-white fw-bold partner-info">
                Partner with us to make the <br /> intangible tangible
              </p>
              <div className="">
          ...
          <div className="col-md-6 d-flex justify-content-end" >
            <div style={{marginRight:"25%"}} data-aos="fade-up">
              <h3 className="footer-socail-links-text">Social Links</h3>
              <div className="mt-4">
                <a
      ...
      <div id="fotter-border" className="text-center  p-2">
        <small className="copy-write-text">
          ...
          <a className="ith-tech">ITH Technologies</a>
        </small>
      </div>
    </div>
  );
